...
export const metadata: Metadata = {
  ...
  description: "Learn about Shahriar Haque Abir's background in technical operations, integration engineering, application support, and cybersecurity-focused delivery.",
  openGraph: {
    type: "website",
    url: `${siteUrl}/about`,
    siteName,
