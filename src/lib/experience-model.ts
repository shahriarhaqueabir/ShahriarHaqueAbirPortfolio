...
export const CAREER_STATES: CareerState[] = [
  {
    ...
    summary: "Physical and operational systems: networks, optical fiber, QA environments, and on-call support.",
    primarySkills: ["network operations", "Linux", "QA", "troubleshooting", "systems thinking"],
  ...
  {
    id: "ai-automation",
    label: "AI and Automation Engineering",
    summary: "Modern system design with RAG, local LLMs, automation pipelines, workflow orchestration, and developer tooling.",
    primarySkills: ["FastAPI", "Qdrant", "Docker Compose", "n8n", "RAG", "local LLMs"],
    systemExposure: "Adaptive systems where retrieval, automation, and orchestration reduce operational friction.",
    answers: ["What has he built recently?", "Can he build AI-enabled systems with practical constraints?"],
    nextViews: ["projects", "stack", "lab"],
  },
];
...
export const VIEW_GOALS: Record<ViewKey, ViewGoal> = {
  ...
  projects: {
    ...
    layer: "logic",
    intentDescription: "Technical implementations, AI systems, automation workflows, architecture, and case studies.",
    nextViews: ["stack", "stats", "lab"],
  },
  experience: {
  ...
  stack: {
    ...
    layer: "logic",
    intentDescription: "Technology stack, frameworks, APIs, AI tooling, automation, infrastructure, and operations tools.",
    nextViews: ["projects", "skills", "lab"],
  },
  vision: {
  ...
  lab: {
    coreQuestion: "How does this profile fit my context?",
    layer: "experience",
    intentDescription: "AI-assisted synthesis, fit analysis, custom CV framing, and contextual profile reports.",
    nextViews: ["projects", "experience", "contact"],
  },
  contact: {
    ...
    nextViews: ["hero", "projects", "experience"],
  },
};
